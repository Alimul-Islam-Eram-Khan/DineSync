          ...
          <div class="row">
            <div class="col-lg-3">
              ...
              <div class="panel panel-default">
                ...
                <ul class="list-group">
                  <li class="list-group-item text-muted" style="text-align: center;">Profile Restaurant</li>
                  ...
                  <li class="list-group-item text-right"><span class="pull-left"><strong>License No</strong></span>
                  ...
                  <li class="list-group-item text-right"><span class="pull-left"><strong>Open / Close</strong></span>
                    ...
                    foreach ($result as $r) {
                    ?>
                      <div class="text-right" style="color: rgb(63, 153, 63); font-weight: 600;" class="opening">Opening :<?php echo date('H:i', strtotime($r['opening_res'])); ?> h</div>
                    <?php
                    }
                    ?>
                    <?php
                    ...
                    foreach ($result as $r) {
                    ?>
                      <div style="color: rgb(63, 153, 63); font-weight: 600;" class="opening">Closing : <?php echo date('H:i', strtotime($r['closing_res'])); ?> h</div>
                    <?php
                    }
                    ?>
                  </li>
