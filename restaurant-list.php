          ...
          <form action="book.php" method="POST">
            ...
            <div class="col-md-12 text-center" id="menu-filters">
              <ul class="ul-menus">
                ...
                <li><a class="filter " data-filter=".wine_bar">Bar Restaurant</a></li>
                <li><a class="filter " data-filter=".bio">Buffet Restaurant</a></li>
                <li><a class="filter " data-filter=".bistro_brass">Bistro</a></li>
                <li><a class="filter " data-filter=".waffles">Fast Food Restaurant</a></li>
                ...
                <li><a class="filter " data-filter=".tea">Cafe Restaurant</a></li>
