              ...
              <form class="form-horizontal" method="POST" action="profil-user.php">
                <div class="">
                  ...
                  <div class="form-inline">
                    <div class="col mb-2 d-flex py-4" style="background: white;">
                      <div class="align-self-center">
                        <p class="mb-0"><span class="color-span-title"><i class="fas fa-user-tag fa-lg fa-fw mr-1" aria-hidden="true"></i> Last Name :</span> <input style="text-transform: capitalize;" type="text" name="fullname" class="form-control" required="" placeholder="Example: Fahim" value="<?php echo $row['rc_name']; ?>"> </p>
                      </div>
                    </div>
                    <div class="col mb-2 d-flex py-4" style="background: white;">
                      <div class="align-self-center">
                        <p class="mb-0"><span class="color-span-title"><i class="fas fa-user fa-lg fa-fw mr-1" aria-hidden="true"></i> First Name : </span> <input style="text-transform: capitalize;" type="text" name="first_name" class="form-control no-outline" required="" placeholder="Example: Fahim" value="<?php echo $row['first_name']; ?>"></p>
                      </div>
                    </div>
                  </div>
                  <div class="form-inline">
                    <div class="col mb-2 d-flex py-4" style="background: white;">
                      <div class="align-self-center">
                        <p class="mb-0"><span class="color-span-title"><i class="fas fa-phone-square-alt fa-lg fa-fw mr-1" aria-hidden="true"></i> Phone : </span> <input type="text" name="phone" class="form-control" required="" placeholder="Telephone" value="0<?php echo $row['phone']; ?>"></p>
                      </div>
                    </div>
                    <div class="col mb-2 d-flex py-4" style="background: white;">
                      <div class="align-self-center">
                  ...
                  <div class="form-inline">
                    <div class="col mb-2 d-flex py-4" style="background: white;">
                      <div class="align-self-center">
                        <p class="mb-0"><span class="color-span-title"><i class="fas fa-lock fa-lg fa-fw mr-1" aria-hidden="true"></i></i> Password : <input type="password" name="password" class="form-control" required="" placeholder="PassKey" value="<?php echo $row['password']; ?>"></p>
                      </div>
                    </div>
                    <div class="col mb-2 d-flex py-4 ">
                      <div class="align-self-center">
                        <div class="col-md-7">
                          ...
                          <div class="col-md-8">
                            <input id="btn-loader" type="submit" value="Confirm" name="save" class="btn btn-warning">
                          </div>
                        </div>
                      </div>
                    </div>
